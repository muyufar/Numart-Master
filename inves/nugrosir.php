...
// Total semua penjualan (cash + piutang)
...
// Grafik 7 Hari Terakhir - Total cash + piutang
...
// Grafik Bulanan - Total cash + piutang
...
FROM invoice WHERE invoice_cabang = 1 AND invoice_date BETWEEN '$startOfPeriod' AND '$endOfPeriod'");
$labaCabang1 = !empty($labaCabang1Result) ? ($labaCabang1Result[0]['laba_bersih'] ?? 0) : 0;
$bagiHasilDukun = $labaCabang1 * 0.45;

// Numart Pakis (Cabang 2) - 30%
...
FROM invoice WHERE invoice_cabang = 2 AND invoice_date BETWEEN '$startOfPeriod' AND '$endOfPeriod'");
$labaCabang2 = !empty($labaCabang2Result) ? ($labaCabang2Result[0]['laba_bersih'] ?? 0) : 0;
$bagiHasilPakis = $labaCabang2 * 0.30;
...
FROM invoice WHERE invoice_cabang = 3 AND invoice_date BETWEEN '$startOfPeriod' AND '$endOfPeriod'");
$labaCabang3 = !empty($labaCabang3Result) ? ($labaCabang3Result[0]['laba_bersih'] ?? 0) : 0;
$bagiHasilSrumbung = $labaCabang3 * 0.50;
...
FROM invoice WHERE invoice_cabang = 5 AND invoice_date BETWEEN '$startOfPeriod' AND '$endOfPeriod'");
$labaCabang5 = !empty($labaCabang5Result) ? ($labaCabang5Result[0]['laba_bersih'] ?? 0) : 0;
$bagiHasilTegalrejo = $labaCabang5 * 0.45;
...
COALESCE(c.customer_nama, 'Umum') as customer_nama, i.invoice_piutang
FROM invoice i
...
// Top 5 Member Retail dengan belanja terbanyak (periode filter) - cash + piutang
...
// Top 5 Member Grosir dengan belanja terbanyak (periode filter) - cash + piutang
// Exclude Numart Dukun (akun toko sendiri)
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card info">
                    <div class="card-body">
                        ...
                        <div class="stat-sub">Setelah Bagi Hasil PCNU</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="laba-rugi-card mb-4">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="laba-rugi-item" style="background: #e0f2fe; border-left: 4px solid #0ea5e9;">
                            <span><strong><i class="fas fa-hand-holding-usd mr-2"></i>Pendapatan Lain-lain:</strong></span>
                            <span></span>
                        </div>
                    ...
                    <table class="table recent-table mb-0">
                        ...
                        <tbody>
                            <?php foreach ($recentTrans as $trans): 
                                ...
                                $paymentBadge = $trans['invoice_piutang'] == 1 ? 'warning' : 'success';
                                $paymentLabel = $trans['invoice_piutang'] == 1 ? 'Piutang' : 'Cash';
                            ?>
                            <tr>
                                ...
                                <td><span class="badge badge-<?php echo $paymentBadge; ?>"><?php echo $paymentLabel; ?></span></td>
