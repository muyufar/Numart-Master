      ...
      <div class="row mb-2">
        <div class="col-sm-8">
          ...
          <div class="btn-cash-piutang">
            ...
            <?php endif; ?>
            <!-- <a class="btn btn-warning" data-toggle="modal" href='#modal-id-draft' data-backdrop="static">
...
<?php endforeach; ?>
                ...
                <div class="col-md-6 col-lg-5">
                  ...
                  <div class="payment">
                    ...
                    ?>
                    <?php if ($jmlDataSn < 1) { ?>
                      <!-- <button class="btn btn-warning" type="submit" name="updateStockDraft">
                        <i class="fa fa-clock-o"></i> Transaksi Pending
                      </button> -->
                      <button class="btn btn-primary updateStok" type="submit" name="updateStock">
                        <i class="fa fa-check-circle"></i> Simpan Payment
                      </button>
                    <?php } else { ?>
                      <!-- <a href="#!" class="btn btn-secondary jmlDataSn" type="" name="">
                        <i class="fa fa-clock-o"></i> Transaksi Pending
                      </a> -->
                      <a href="#!" class="btn btn-secondary jmlDataSn" type="" name="">
                        <i class="fa fa-check-circle"></i> Simpan Payment
